    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
      ...
      return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            _a.sent();
            res.cookie(index_1.TOP_LEVEL_OAUTH_COOKIE_NAME, 1);
            return [4 /*yield*/, next()];
          case 4:
            _a.sent();
            return [2 /*return*/];
          case 5:
            ...
            return [3 /*break*/, 6];
          case 6:
            res.cookie(index_1.TEST_COOKIE_NAME, '1');
            if (returnHeader) {
              res.status(403);
              res.header(exports.REAUTH_HEADER, '1');
              shop = undefined;
              if (session) {
                shop = session.shop;
              ...
              (0, utilities_1.redirectToAuth)(routes, req, res);
            }
            return [2 /*return*/];
        }
      });
